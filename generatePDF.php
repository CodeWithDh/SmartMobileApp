...
<table cellpadding='5' cellspacing='0' border='1'>
    <tr><td><b>IMEI</b></td><td>{$row['IMEI']}</td></tr>
    <tr><td><b>Mobile Name</b></td><td>{$row['mobile_name']}</td></tr>
    <tr><td><b>Seller Name</b></td><td>{$row['seller_name']}</td></tr>
    <tr><td><b>Seller Mobile</b></td><td>{$row['seller_mobile']}</td></tr>
    <tr><td><b>Fault Description</b></td><td>{$row['fault_description']}</td></tr>
    <tr><td><b>Price</b></td><td>{$row['price']}</td></tr>
    <tr><td><b>Purchase Date</b></td><td>{$row['purchase_date']}</td></tr>
</table>
