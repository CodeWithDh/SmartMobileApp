...
<head>
    <meta charset="UTF-8">
    <title>Returned Mobiles List</title>
...
<div class="content">
    ...
    <table>
        ...
        <?php
        $sql = "SELECT * FROM purchased_mobiles WHERE status = 'returned'";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo "<tr><td colspan='6' style='text-align:center;'>No returned mobiles found</td></tr>";
        }
