...
// ✅ HTML Content
$html = '
<div class="heading">▸ Sale Details</div>
...
<table>
    ...
    <tr><th>Sold Price</th><td>₹ ' . htmlspecialchars($row['sold_price']) . '</td></tr>
    <tr><th>Sell Date</th><td>' . htmlspecialchars($row['sell_date']) . '</td></tr>
</table>
